/**
 * LE PERLÉ — Cart System
 * Shopping cart functionality with sessionStorage persistence
 */
...
(function () {
  ...
  function getProductData(button) {
    ...
    const customQuantity = parseInt(button.dataset.productQuantity || '1', 10) || 1;
  ...
  function addToCart(product) {
    ...
    const quantityToAdd = typeof product.quantity === 'number' && product.quantity > 0 ? product.quantity : 1;
